...
<head>
    ...
    <link rel="stylesheet" href="../../../css/adminsearchstores.css" />
    ...
    <div class="wrapper">
        ...
        <div class="main">
            <div>
                ...
                <div class="content">
                    <p class="menuName">가게 조회</p>
                    <form method="get" action="<c:url value='/admin/searchstores'/>">
                    ...
                    <div class="page">
                        <ul class='paging'>
                            ...
                            <c:forEach var="p" begin="${map.startPage}" end="${map.endPage}">
                                ...
                                <c:if test="${p != store.page}">
                                <li><a href='searchstores?page=${p}&s_type=${store.s_type}&s_value=${store.s_value}'>${p}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${map.isNext }">
                                <li><a href="searchstores?page=${map.endPage+1 }&s_type=${store.s_type}&s_value=${store.s_value}"> >> </a></li>
                            </c:if>
                        </ul>
                    </div>
                </div>
