...
<head>
    ...
    <link rel="stylesheet" href="../../../css/adminstoresales.css" />
</head>
<body>
    <div class="wrapper">
        <div class="menu">
        ...
        <div class="main">
            <div>
                ...
                <div class="content">
                    <p class="menuName">가게 매출 조회</p>
                    <form method="get" action="<c:url value='/admin/storesales'/>">
                    <div class="usersFilter">
                        <select class="selectBox" name="s_type">
                            <option value="store_id" ${storeSales.s_type == 'store_id' ? 'selected' : ''}>ID</option>
                        </select>
                    </div>
                    <div class="filterValue">
                        <input class="searchBox" type="text" name="store_id" value="${storeSales.store_id != null ? storeSales.store_id : ''}">
                        <div class="magnifying">
                            <button class="magnifyingButton" type="submit" value=""> 
                        </div>
                    </div>
                    <div class="dateDiv">
                        <label for="start_date">시작 날짜</lable>
                        <input id="start_date" class="dateBox" type="date" name="start_date" value="${storeSales.start_date != null ? storeSales.start_date : ''}">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <label for="end_date">종료 날짜</lable>
                        <input id="end_date" class="dateBox" type="date" name="end_date" value="${storeSales.end_date != null ? storeSales.end_date : ''}">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <!-- <button id="dateButton" type="submit" value="조회"> -->
                    </div>
                    </form>
                    <div class="result">
                        <div class="resultDiv">
                            ...
                            <table border="1">
                                ...
                                <tr class="tableValue">
                                    <td>${lastYearSales != null ? lastYearSales : 0}</td>
                                    <td>${thisYearSales != null ? thisYearSales : 0}</td>
                                    <td>${previousMonthSales != null ? previousMonthSales : 0}</td>
                        ...
                        <div class="resultDiv">
                            ...
                            <table border="1">
                                ...
                                <tr class="tableValue">
                                    <td>${todayOrderCount != null ? todayOrderCount : 0}</td>
                                    <td>${thisMonthOrderCount != null ? thisMonthOrderCount : 0}</td>
                                    <td>${thisYearOrderCount != null ? thisYearOrderCount : 0}</td>
                        ...
                        <div class="resultDiv">
                            ...
                            <table border="1" class="notConfirmedStoreTable">
                                ...
                                <tr class="tableValue">
                                    <td>${periodSales != null ? periodSales : 0}</td>
                                    <td>${periodOrderCount != null ? periodOrderCount : 0} 건</td>
                                </tr>
                            </table>
                        </div>
                    </div>
