			...
			<header>
				<div class="headerContainer">
					...
					<a href="${pageContext.request.contextPath}/login">
						<img src="${pageContext.request.contextPath}/img/user_login.png" alt="로그인"
							class="icon logoutIcon">
					</a>
				</div>
			</header>
			<main>
				<div class="signupContainer">
					...
					<form id="signupForm" class="signupForm" action="${pageContext.request.contextPath}/user/signup"
						method="post">
